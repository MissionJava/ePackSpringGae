	...
	<div class="container">
				...
				<%
					if ((session.getAttribute("userName") != null)
						...
						SimpleDateFormat dateFormat = new SimpleDateFormat(
								"dd-MMM-yyyy");
						Date date = new Date();
						out.print("Welcome <b>" + session.getAttribute("userName")
								+ "!</b> Date <b>" + dateFormat.format(date) + "</b>");
					}
				%>
			</div>
			<div class="navbar">
		...
		<div class="row-fluid box">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="icon-edit"></i>Select Vendor
				</h2>
			</div>
			<div class=""box-content">
				<!-- Jumbotron -->
				<form name="selectvendorForm" id="selectvendorForm"
					class="bs-docs-example form-horizontal"
					action="selectvendor" method="POST">
					<div class="control-group">
						<label class="control-label">1-3 day</label>
						<div class="controls">

							<select id="inputWarning" name="1_3day"
								class="select2 form-control select2-offscreen" tabindex="-1"
								title="" required="required" onfocus="hideStatus()">
								<option>--Select Vendor--</option>
								<option value="1">A1 Express</option>
								<option value="2">eKart</option>
							</select>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">3-5 day</label>
						<div class="controls">
				...
				<div id="sendParcelDetails" align="center">
					<h3>SendparcelBookingId : ${sendparcelBookingId}, SendParcel
						Details: ${sendParcelDetails}</h3>
