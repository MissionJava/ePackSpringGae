...
<title>Pack7 :: Login/Registration Page</title>
<style>
body {
	padding-top: 90px;
}
...
<link rel="stylesheet" href="assets/css/login/css/bootstrap.min.css">
	<link rel="stylesheet" href="assets/css/login/css/font-awesome.min.css">
		<link rel="stylesheet" href="assets/css/login/css/bootsnipp.min.css">
			<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
			<!--[if lt IE 9]>
    	<script src="//cdnjs.cloudflare.com/ajax/libs/html5shiv/3.6.2/html5shiv.js"></script>
    	<script src="//cdnjs.cloudflare.com/ajax/libs/respond.js/1.2.0/respond.js"></script>
    <![endif]-->
			<script src="assets/css/login/js/jquery-1.11.0.min.js"></script>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="authenticate" method="post" role="form"
									style="display: block;">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1"
											class="form-control" placeholder="Username" value="test">
									</div>
									<div class="form-group">
										<input type="password" name="password" id="password"
											tabindex="2" class="form-control" placeholder="Password" value="test">
									</div>
								...
								<form id="forgot-form" action="" method="post" role="form"
									...
									<fieldset>
										<h2 style="text-align: center">Request password reset</h2>
										<div class="form-group">
